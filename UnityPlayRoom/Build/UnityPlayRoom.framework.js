...
var ASM_CONSTS = {
  4474160: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4474215: ($0) => { performance.now = function() { return $0; }; },  
 4474263: ($0) => { performance.now = function() { return $0; }; },  
 4474311: () => { performance.now = Module['emscripten_get_now_backup']; }
};
