...
var ASM_CONSTS = {
  4474848: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4474903: ($0) => { performance.now = function() { return $0; }; },  
 4474951: ($0) => { performance.now = function() { return $0; }; },  
 4474999: () => { performance.now = Module['emscripten_get_now_backup']; }
};
